              ...
              <div className="p-4 space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-sm">{isRussian ? "Имя пользователя" : "Username"}</span>
                      <span className="text-sm text-neutral-400">{user?.username}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm">{isRussian ? "Email" : "Email"}</span>
                      <span className="text-sm text-neutral-400">{user?.email}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm">{isRussian ? "Компания" : "Company"}</span>
                      <span className="text-sm text-neutral-400">{user?.company_name || (isRussian ? "Не указана" : "Not specified")}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <h4 className="text-sm font-medium text-neutral-400">
                    {isRussian ? "Предпочтения" : "Preferences"}
                  </h4>
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-sm">{isRussian ? "Язык" : "Language"}</span>
                      <span className="text-sm text-neutral-400">{isRussian ? "Русский" : "English"}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm">{isRussian ? "Тема" : "Theme"}</span>
                      <span className="text-sm text-neutral-400">{isRussian ? "Темная" : "Dark"}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-4 border-t border-white/10 space-y-2">
                  <motion.button
                    ...
                    className="w-full px-4 py-2 bg-orange-500 hover:bg-orange-600 rounded-lg transition-colors text-sm"
                  >
                    {isRussian ? "Управление аккаунтом" : "Account Management"}
                  </motion.button>
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    ...
                    className="w-full px-4 py-2 bg-red-500/20 hover:bg-red-500/30 text-red-400 hover:text-red-300 rounded-lg transition-colors text-sm"
                  >
